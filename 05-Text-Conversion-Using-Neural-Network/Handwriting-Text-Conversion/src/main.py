...
class FilePaths:
    ...
    fn_char_list = '../Handwriting-Text-Conversion/model/charList.txt'
    fn_summary = '../Handwriting-Text-Conversion/model/summary.json'
    fn_corpus = '../Handwriting-Text-Conversion/data/corpus.txt'
